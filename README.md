...
|`travelTimeToStation`|How long does it take you to get from the mirror to the station? The value is given in minutes. (this was the former `delay` option)<br><br>**Type:** `integer`<br>**Default vaule:** `10 // 10 minutes`|
