...
|`marqueeLongDirections`|Makes a 'ticker' text out of all direction descriptions bigger than 25 characters. If this value is false, the descriptions are trimmed the station names. <br> *Note: The rendering on the mirror is not perfect, but it is OK in my opinion. If the movement is not fluent enough for you, you should turn it off.*<br><br>**Type:** `boolean`<br>**Default vaule:** `true`|
