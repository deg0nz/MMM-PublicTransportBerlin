...
const vbbClient = createClient(bvgProfile, 'MagicMirror2 module MMM-PublicTransportBerlin v' + pjson.version + ' (https://github.com/deg0nz/MMM-PublicTransportBerlin)');
